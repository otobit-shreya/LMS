        ...
        <div className='container'>
            <div className={`rounded-2xl bg-white my-5 w-fit mx-auto ${isDialogOpen? 'z-50 relative':''}`}>
                ...
                <div className={`flex pt-2  ${isDialogOpen ? 'gap-x-7 pb-4' : 'gap-x-12 pb-5'} items-center justify-center px-4`}>
                   ...
                   {!isDialogOpen && <button className='flex items-center flex-auto leading-10 px-2 w-fit gap-x-2 text-base font-["Poppins"] text-center' onClick={() => {setIsDialogOpen(true)}}>
                ...
                {isDialogOpen && <>
                    <div className='flex pb-4 gap-x-10 items-center justify-center px-4'>
                        ...
                        <label htmlFor='files' className='flex items-center gap-x-2 cursor-pointer text-base font-["Poppins"] text-center'>
                    ...
                    <div className='flex pb-4 gap-x-10 items-center justify-center px-4'>
                        ...
                        <label htmlFor='audio' className='flex items-center gap-x-2 cursor-pointer text-base font-["Poppins"] text-center'>
                        ...
                        <label htmlFor='reel' className='flex items-center gap-x-2 cursor-pointer text-base font-["Poppins"] text-center'>
                            <i className="bi bi-file-play"></i>
                            <span>upload reels</span>
                        </label>

                        <input id='video' type='file' accept='video/*' className='hidden' />
                        <label htmlFor='video' className='flex items-center gap-x-2 cursor-pointer text-base font-["Poppins"] text-center'>
